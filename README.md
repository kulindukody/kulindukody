...
- Adversary simulation and red team tooling  
- Windows & Active Directory exploitation  
- Evasion, OPSEC, and tradecraft refinement  

I don’t just use tools — I **build them, modify them, and break detections**.

---

## 🛠️ Areas of Focus
- Malware Development (C / C++ / Rust)
